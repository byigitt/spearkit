...
> **EmbedPresetInput** = `string` \| \{ `author?`: `APIEmbedAuthor`; `description?`: `string`; `fields?`: readonly `APIEmbedField`[]; `footer?`: `APIEmbedFooter`; `image?`: \{ `url`: `string`; \}; `thumbnail?`: \{ `url`: `string`; \}; `timestamp?`: `Date` \| `number` \| `string`; `title?`: `string`; `url?`: `string`; \}
