---
title: "Components"
description: "Buttons, select menus and modals in spear follow one pattern: define the appearance, the custom-id pattern, and the handler in one place; register it; then build() the discord.js c"
---
