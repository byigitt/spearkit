---
title: "I18nOptions"
description: "I18nOptions in the spearkit API."
---
...
| <a id="property-missing"></a> `missing?` | (`key`: `string`, `locale`: `string`) => `string` | Customize missing keys. Default: return the key itself. |
