---
title: "Guards"
description: "Guards are declarative preconditions that run before a handler. They work uniformly across slash commands, components (buttons, selects, modals), prefix commands and context-menu…"
---
...
- [Commands](/docs/guides/commands) — `guards` on slash commands.
- [Components](/docs/guides/components) — `guards` on buttons, selects and modals.
- [Prefix commands](/docs/guides/prefix) — `guards` on text commands.
- [Context menus](/docs/guides/context-menus) — `guards` on "Apps" actions.
- [Cooldowns](/docs/guides/cooldown) — the other built-in precondition.
