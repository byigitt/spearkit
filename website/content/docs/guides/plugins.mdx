---
title: "Plugins"
description: "A plugin is a named, reusable bundle of commands, events and components. It lets you package a feature once and install it into any SpearClient with a single call — useful for shar"
---
