---
title: "ModalContext"
description: "Context for a submitted modal. Exposes the routed params plus the resolved fields, keyed by the field names you declared and typed by each field definition (text inputs are string, radio groups narrow to their option values, checkboxes are boolean, uploads resolve to Attachment[])."
---
...
```ts
new ModalContext<P, Fields>(
   interaction: ModalSubmitInteraction, 
   params: P, 
fields: Fields): ModalContext<P, Fields>;
```
