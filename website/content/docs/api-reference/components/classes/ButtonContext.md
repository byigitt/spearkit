---
title: "ButtonContext\\<P\\>"
description: "Context for a button click."
---

Defined in: [src/components/context.ts:86](https://github.com/byigitt/spearkit/blob/main/src/components/context.ts#L86)

Context for a button click.

## Extends

- [`MessageComponentContext`](MessageComponentContext)\<`P`, `ButtonInteraction`\>
...
> **new ButtonContext**\<`P`\>(`interaction`, `params`): `ButtonContext`\<`P`\>
...
| :------ | :------ | :------ | :------ | :------ |
| <a id="property-interaction"></a> `interaction` | `readonly` | `ButtonInteraction` | - | [`MessageComponentContext`](MessageComponentContext).[`interaction`](MessageComponentContext#property-interaction) |
