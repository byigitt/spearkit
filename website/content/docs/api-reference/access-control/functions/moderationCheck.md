...
description: "Validate that both the moderator and the bot may act on target, returning a ready-to-show reason on the first failing rule. Checks, in order: acting on self…"
---

> **moderationCheck**(`options`): [`ModerationCheckResult`](../type-aliases/ModerationCheckResult)
