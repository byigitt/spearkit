---
title: "File-based loading"
description: "Instead of importing and registering every handler by hand, you can keep one handler per file and let spearkit discover them. The loader imports a directory, inspects each…"
---
...
- [Client](/docs/guides/client) — `load`, `register`, and the registries the loader writes to.
- [Events](/docs/guides/events) — the `event()` helper that event modules export.
