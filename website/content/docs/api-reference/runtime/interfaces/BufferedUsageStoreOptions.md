...
| <a id="property-ondrop"></a> `onDrop?` | (`count`: `number`) => `void` | Observe dropped telemetry events. |
| <a id="property-onerror"></a> `onError?` | (`error`: `unknown`) => `void` | Observe background flush errors. |
