...
description: "Usage tracking records who used what: every successful command, component, and prefix-command invocation becomes a UsageEvent that spearkit can persist to a store and/or mirror…"
---
...
usage event. Reach for the [logger](/docs/guides/logging) for debugging, and usage
