---
title: "Collectors"
description: "discord.js collectors are powerful but fiddly: you wire an event emitter, set a time, write a filter, remember that dismissed modals need their own timeout, and translate the…"
---

Beyond these, see the [pagination and confirm helpers](/docs/api-reference#pagination--confirmation)
