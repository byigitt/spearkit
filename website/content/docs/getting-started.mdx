...
description: "spearkit is discord.js++: it re-exports the entire discord.js surface and adds a fully type-safe layer for events, slash commands and interactive components. This page takes you…"
---
...
with `client.load` (see [File-based loading](/docs/guides/loading)).
...
See [MCP for coding agents](/docs/guides/mcp).

## See also

- [Client](/docs/guides/client) — `SpearClient`, intents, `register`, `start`, deployment.
- [Commands](/docs/guides/commands) — slash commands, subcommands, options, deployment.
- [MCP](/docs/guides/mcp) — Cursor / Claude Code / Claude Desktop setup.
