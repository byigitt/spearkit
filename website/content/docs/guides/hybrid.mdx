...
description: "One definition, two surfaces: a slash command (typed options) and a prefix command (typed args) that share a handler. Use this when a bot still has ! users but you don't want two…"
---
