...
description: "Context-menu commands are the right-click \"Apps\" actions Discord shows on a user or a message. spearkit makes them first-class: define one with userCommand or messageCommand…"
---
...
Both handler contexts extend the shared [`BaseContext`](/docs/guides/context), so
...
See [Cooldowns](/docs/guides/cooldown) and [Guards](/docs/guides/guards) for the shared options.
...
- [Client](/docs/guides/client) — `deployAllCommands` and registration.
- [Guards](/docs/guides/guards) / [Cooldowns](/docs/guides/cooldown) — the shared preconditions.
