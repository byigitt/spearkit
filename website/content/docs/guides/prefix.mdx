...
description: "Alongside slash commands, spearkit can dispatch classic text/prefix commands like !ping. You define them with prefixCommand, enable them with the client's prefix option, and…"
---
...
per-guild prefix from a database or [`createSettings`](/docs/api-reference#persistent-storage).
...
default. See [Cooldowns](/docs/guides/cooldown) for scopes and configuration.
...
- [Commands](/docs/guides/commands) — slash commands.
- [Hybrid commands](/docs/guides/hybrid) — one definition for slash + prefix.
- [Cooldowns](/docs/guides/cooldown) — the shared rate limiter.
- [Usage tracking](/docs/guides/usage) — record who runs which prefix commands.
- [Client](/docs/guides/client) — the `prefix` option and intent presets.
