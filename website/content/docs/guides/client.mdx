...
guide: [Cooldowns](/docs/guides/cooldown), [Scheduled tasks](/docs/guides/scheduler),
[Prefix commands](/docs/guides/prefix), [Context menus](/docs/guides/context-menus),
[Logging](/docs/guides/logging), [Usage tracking](/docs/guides/usage), [Guards](/docs/guides/guards).
