---
title: "MessageContextMenuContext"
description: "Handler context for a message-target context menu."
---

Defined in: [src/context-menus.ts:118](https://github.com/byigitt/spearkit/blob/main/src/context-menus.ts#L118)

## Extends

- [`BaseContext`](../../contexts/classes/BaseContext)\<`MessageContextMenuCommandInteraction`\>
...
```ts
new MessageContextMenuContext(interaction: MessageContextMenuCommandInteraction): MessageContextMenuContext;
```
...
| :------ | :------ | :------ | :------ |
| <a id="property-interaction"></a> `interaction` | `readonly` | `MessageContextMenuCommandInteraction` | [`BaseContext`](../../contexts/classes/BaseContext).[`interaction`](../../contexts/classes/BaseContext#property-interaction) |
...
```ts
get targetMessage(): Message<boolean>;
```

Defined in: [src/context-menus.ts:120](https://github.com/byigitt/spearkit/blob/main/src/context-menus.ts#L120)
