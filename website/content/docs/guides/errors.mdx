---
title: "Discord API errors"
description: "discord.js reports REST failures as DiscordAPIError with a numeric code (10008 \"Unknown Message\", 50013 \"Missing Permissions\", 50007 \"Cannot send DMs to this user\", …). Catching…"
---
