---
title: "UserSelectContext"
description: "Context for a user select; exposes selected ids, users and members."
---

Defined in: [src/components/context.ts:107](https://github.com/byigitt/spearkit/blob/main/src/components/context.ts#L107)

## Extends

- [`MessageComponentContext`](MessageComponentContext)\<`P`, `UserSelectMenuInteraction`\>
...
```ts
new UserSelectContext<P>(interaction: UserSelectMenuInteraction, params: P): UserSelectContext<P>;
```
...
| :------ | :------ | :------ | :------ | :------ |
| <a id="property-interaction"></a> `interaction` | `readonly` | `UserSelectMenuInteraction` | - | [`MessageComponentContext`](MessageComponentContext).[`interaction`](MessageComponentContext#property-interaction) |
...
Defined in: [src/components/context.ts:117](https://github.com/byigitt/spearkit/blob/main/src/components/context.ts#L117)
...
Defined in: [src/components/context.ts:114](https://github.com/byigitt/spearkit/blob/main/src/components/context.ts#L114)
...
Defined in: [src/components/context.ts:111](https://github.com/byigitt/spearkit/blob/main/src/components/context.ts#L111)
