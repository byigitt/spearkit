---
title: "ModalContext\\<P, Fields\\>"
description: "Context for a submitted modal. Exposes the routed params plus the resolved fields, keyed by the field names you declared and typed by each field definition…"
---

Defined in: [src/components/context.ts:174](https://github.com/byigitt/spearkit/blob/main/src/components/context.ts#L174)

Context for a submitted modal. Exposes the routed [params](#property-params) plus the
resolved [fields](#property-fields), keyed by the field names you declared and typed by
...
- [`BaseContext`](../../contexts/classes/BaseContext)\<`ModalSubmitInteraction`\>
...
> **new ModalContext**\<`P`, `Fields`\>(`interaction`, `params`, `fields`): `ModalContext`\<`P`, `Fields`\>

Defined in: [src/components/context.ts:178](https://github.com/byigitt/spearkit/blob/main/src/components/context.ts#L178)
...
| `params` | `P` | - |
| `fields` | `Fields` | Submitted values, keyed by the field names from your modal definition. |

#### Returns

`ModalContext`\<`P`, `Fields`\>
...
| :------ | :------ | :------ | :------ | :------ |
| <a id="property-fields"></a> `fields` | `readonly` | `Fields` | Submitted values, keyed by the field names from your modal definition. | - |
| <a id="property-interaction"></a> `interaction` | `readonly` | `ModalSubmitInteraction` | - | [`BaseContext`](../../contexts/classes/BaseContext).[`interaction`](../../contexts/classes/BaseContext#property-interaction) |
| <a id="property-params"></a> `params` | `readonly` | `P` | - | - |
...
Defined in: [src/components/context.ts:188](https://github.com/byigitt/spearkit/blob/main/src/components/context.ts#L188)
