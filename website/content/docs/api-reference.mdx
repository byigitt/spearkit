...
### Runtime i18n — [guide](/docs/guides/i18n)
...
### Everyday helpers — [guide](/docs/guides/dx)
...
### Hybrid commands — [guide](/docs/guides/hybrid)
...
### Polls — [guide](/docs/guides/messages#polls)
