---
title: "Contexts"
description: "Every spear handler — command, button, select, modal — receives a context object. They all share BaseContext, which smooths over discord.js' reply/defer/edit/follow-up state machin"
---
