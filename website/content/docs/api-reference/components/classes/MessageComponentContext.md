---
title: "MessageComponentContext\\<P, I\\>"
description: "Base context for message-component interactions (buttons and selects). Adds the component-only update/deferUpdate/showModal helpers and the routed, typed…"
---

Defined in: [src/components/context.ts:37](https://github.com/byigitt/spearkit/blob/main/src/components/context.ts#L37)
...
routed, typed [params](#property-params).

## Extends

- [`BaseContext`](../../contexts/classes/BaseContext)\<`I`\>

## Extended by

- [`ButtonContext`](ButtonContext)
- [`StringSelectContext`](StringSelectContext)
- [`UserSelectContext`](UserSelectContext)
- [`RoleSelectContext`](RoleSelectContext)
- [`ChannelSelectContext`](ChannelSelectContext)
- [`MentionableSelectContext`](MentionableSelectContext)
...
| :------ | :------ |
| `P` | - |
| `I` *extends* [`AnyComponentInteraction`](../type-aliases/AnyComponentInteraction) | [`AnyComponentInteraction`](../type-aliases/AnyComponentInteraction) |

## Constructors

### Constructor

> **new MessageComponentContext**\<`P`, `I`\>(`interaction`, `params`): `MessageComponentContext`\<`P`, `I`\>
...
| :------ | :------ | :------ | :------ | :------ |
| <a id="property-interaction"></a> `interaction` | `readonly` | `I` | - | [`BaseContext`](../../contexts/classes/BaseContext).[`interaction`](../../contexts/classes/BaseContext#property-interaction) |
| <a id="property-params"></a> `params` | `readonly` | `P` | Params extracted from the custom-id pattern. | - |
