---
title: "Commands"
description: "Slash commands in spear are defined as a single object: the metadata, the typed options, and the handler all live together. spear serialises them for discord and routes incoming in"
---
