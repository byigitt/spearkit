---
title: "MentionableSelectContext"
description: "Context for a mentionable (user + role) select."
---

Defined in: [src/components/context.ts:149](https://github.com/byigitt/spearkit/blob/main/src/components/context.ts#L149)

## Extends

- [`MessageComponentContext`](MessageComponentContext)\<`P`, `MentionableSelectMenuInteraction`\>
...
```ts
new MentionableSelectContext<P>(interaction: MentionableSelectMenuInteraction, params: P): MentionableSelectContext<P>;
```
...
| :------ | :------ | :------ | :------ | :------ |
| <a id="property-interaction"></a> `interaction` | `readonly` | `MentionableSelectMenuInteraction` | - | [`MessageComponentContext`](MessageComponentContext).[`interaction`](MessageComponentContext#property-interaction) |
...
Defined in: [src/components/context.ts:162](https://github.com/byigitt/spearkit/blob/main/src/components/context.ts#L162)

##### Returns

`Collection`\<`string`, `GuildMember` \| `APIGuildMember`\>
...
Defined in: [src/components/context.ts:159](https://github.com/byigitt/spearkit/blob/main/src/components/context.ts#L159)

##### Returns

`Collection`\<`string`, `Role` \| `APIRole`\>
...
Defined in: [src/components/context.ts:156](https://github.com/byigitt/spearkit/blob/main/src/components/context.ts#L156)
...
Defined in: [src/components/context.ts:153](https://github.com/byigitt/spearkit/blob/main/src/components/context.ts#L153)
