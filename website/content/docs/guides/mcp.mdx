...
description: "spearkit ships a stdio MCP server so Cursor, Claude Code, Claude Desktop, and other MCP clients can pull the right recipe instead of inventing discord.js boilerplate. It reads the…"
---
