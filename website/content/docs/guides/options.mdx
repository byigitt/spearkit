---
title: "Options"
description: "Slash command options are declared as a map of name → builder. spear infers the exact value type each option resolves to, so your handler's ctx.options is fully typed — no casts, n"
---
