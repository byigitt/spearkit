...
- [`MessageComponentContext`](MessageComponentContext)\<`P`, `RoleSelectMenuInteraction`\>
...
| :------ | :------ | :------ | :------ | :------ |
| <a id="property-interaction"></a> `interaction` | `readonly` | `RoleSelectMenuInteraction` | - | [`MessageComponentContext`](MessageComponentContext).[`interaction`](MessageComponentContext#property-interaction) |
