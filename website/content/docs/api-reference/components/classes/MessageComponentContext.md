---
title: "MessageComponentContext"
description: "Base context for message-component interactions (buttons and selects). Adds the component-only update/deferUpdate/showModal helpers and the routed, typed params."
---
...
```ts
new MessageComponentContext<P, I>(interaction: I, params: P): MessageComponentContext<P, I>;
```
