---
title: "Scaling: one process to many hosts"
description: "The same command/component definitions should work in a hobby bot and a large verified app. Scaling changes the runtime around handlers, not spearkit's definition API."
---
